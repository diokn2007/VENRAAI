...
const pathAutorep = join(resolvePath(process.cwd(),'nguyenblue','Data','autorep.json'));
function onLoad() {
...
function Running( {
  ...
  const caurep = JSON.parse(readFileSync(resolvePath(global.nguyenblue.Lyrics, "autorep.json")));
